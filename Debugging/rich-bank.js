...
function createAccount(newAccountId, newAccountOwner) {
	// Callback to validate each time createAccount is run. 
...
function depositMoney(accountId, amount) {
	...
	if (amount <= 0) { // Check value is not 0 or less
	...
	if (amount === Infinity) { //Invalidates if amount is Infinity. 
...
function withdrawMoney(accountId, amount) {
	...
	if (typeof amount !== 'number') { // Check value is number
		// throw new Error("Invalid input. Value must be integer.");
...
createAccount(3, "");
createAccount(3, "  ");
createAccount(3, "Adam") // Added for testing
createAccount(4, "Fred") // Added for testing
createAccount(4, "Doug") // Added for testing
createAccount(5, "Doug") // Added for testing
