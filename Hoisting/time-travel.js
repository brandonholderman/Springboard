...
destination = 'Medevil Europe'
console.log(destination)

const travelDate = '2024-03-15'
console.log(travelDate)

travelDate = 'duh this wont\'t work'
console.log(travelDate)

/*
Observations: console reports `TypeError: Assignment to constant variable.`
*/
...
/*
Observations: console reports undefined since the console.log happens before the variable has been declared. 
*/
